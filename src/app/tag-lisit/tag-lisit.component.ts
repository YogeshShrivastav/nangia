...
@Component({
  selector: 'app-tag-lisit',
  templateUrl: './tag-lisit.component.html'

})
export class TagLisitComponent implements OnInit { 
...
pageSize:any=50;  
  ...
  getallknowlist(pagelimit:any=20,start:any=0,action:any=''){
    ...
    this.db.FetchData({'search':this.search,'start':this.start,'pagelimit':this.pagelimit},'Knowledge/get_tag_knowledge_base')
      .subscribe( r=>{
      console.log(r);
