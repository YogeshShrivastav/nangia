...
export class EdituserComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe(params=>{
      ...
      this.userid = params.id;
        ...
        this.pagestart = params.pagestart;
    });
  ...
  saveUser(myform:any){
    ...
    this.form.add_category = this.form.add_category || 0;
  ...
  edit_user(){
    ...
    .subscribe(result=>{
     ...
     this.form.add_category =parseInt(this.form.add_category );
...
get_approver_user(){
  ...
  .subscribe( r =>{
   ...
   updateuser(){
    ...
    this.form.download_document  = this.form.download_document  ? this.form.download_document : '';
    this.form.add_document  = this.form.add_document  ? this.form.add_document : '';
    this.form.landline  = this.form.landline  ? this.form.landline : '';
    this.form.news_uploader  = this.form.news_uploader  ? this.form.news_uploader : '';
    this.form.view_document  = this.form.view_document  ? this.form.view_document : '';
    this.form.add_category  = this.form.add_category  ? this.form.add_category : '';
    this.form.default_download_limit  = this.form.default_download_limit  ? this.form.default_download_limit : '';
    ...
    .subscribe((result)=>{
      ...
      if(result['message'] == "Profile Updated Successfully"){
        ...
        this.router.navigate(['/user-list/'+this.pagestart]);
