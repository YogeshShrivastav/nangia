...
export class DatabaseService {
    ...
    // myurl:string = "http://localhost/nangia_api/";
    // DbUrl:string = "http://localhost/nangia_api/index.php/";
    ...
    constructor(
        ...
        navigation(){
            ...
            }else if(  this.datauser.access_level == '4'  ){
                home_page = '/dashboard';
                ...
                if( this.token){
                    ...
                    dialogRef.afterClosed().subscribe(r => {
                        if (r) { 
                            ...
                            this.token = r.token;
                            this.dialog.success('Your login Successfully! Please try agian.'); return;
                         }
